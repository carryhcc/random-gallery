...
<head>
    ...
    <link rel="stylesheet" href="/css/pages/download-detail-web.css" media="(min-width: 769px)">
    <link rel="stylesheet" href="/css/pages/download-detail-mobile.css" media="(max-width: 768px)">
